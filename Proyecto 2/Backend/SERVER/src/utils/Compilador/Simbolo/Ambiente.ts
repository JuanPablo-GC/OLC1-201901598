...
import { EnFuncion } from "../Instrucciones/EnFuncion"
import { Arreglo } from "../Instrucciones/Arreglo"

export class Ambiente {

    private variables: Map<string, Symbol>
    public funciones: Map<string, EnFuncion>
    public arreglos: Map<string, Arreglo>

    constructor(public anterior: Ambiente | null) {
     ...
     */
    public guardar_funcion(id: string, funcion: EnFuncion) {
     ...
     */
    public get_funcion(id: string): EnFuncion | undefined | null {
        let env: Ambiente | null = this
        while (env != null) {
