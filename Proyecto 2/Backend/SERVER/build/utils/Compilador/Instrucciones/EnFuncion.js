...
exports.EnFuncion = void 0;
const Instruccion_1 = require("../Abstracto/Instruccion");
const Permanencia_1 = require("../Permanencia/Permanencia");
const Error_1 = require("../Error/Error");
class EnFuncion extends Instruccion_1.Instruccion {
    ...
    execute(env) {
        ...
        if (c)
            throw new Error_1.error("Semantico", `La funcion que se quiere guardar ya tiene el nombre '${this.name}' registrado como funcion, variable o array `, this.line, this.column);
        ...
        array_parametro.forEach(x => {
            if (i != array_parametro.indexOf(x) //que no sea el mismo, porque ira a buscar el nombre a todo el array
                ...
                throw new Error_1.error("Semantico", `La funcion  '${this.name}' tiene un parametro repetido llamado '${x}'`, this.line, this.column);
            }
            i++;
        });
